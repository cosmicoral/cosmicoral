...
- **[Mosaic Kitchen](https://github.com/cosmicoral/Mosaic-Kitchen-AI)** — Full-stack AI meal-planning and grocery platform for multicultural households, translating my PhD research on food practices into a consumer product. Live at [mosaickitchen.gethenfieldlabs.com](https://mosaickitchen.gethenfieldlabs.com), taking real payments. Built with **React + TypeScript, Node.js/Express, PostgreSQL and OpenAI structured outputs**, with **PostgreSQL-backed session auth, Google OAuth, Stripe billing in live mode, SSE streaming, deterministic post-generation validation, bilingual generation/translation, pantry-aware planning and per-account AI cost metering**. Deployed on a **Hetzner VPS** behind nginx and Let's Encrypt, frontend on **Vercel**, Postgres in London. Backed by **371 automated tests**, twelve of which compare source files against each other to catch one fact drifting apart in two places. Ships with a UK GDPR Article 30 record, explicit Article 9 consent for health and belief-revealing data, and a Consumer Contracts Regulations cancellation waiver recorded with the wording version and the language it was displayed in. Designed around culturally specific food preferences, household inventory, budget-aware planning and food-waste reduction.


- **[GrowthPilot](https://github.com/cosmicoral/GrowthPilot-CockroachDB-X-AWS-Hackathon-2026)** — Memory-first multi-agent GTM platform co-built with **Python, FastAPI, React, TypeScript, CockroachDB, AWS Bedrock, Titan embeddings and SSE**. Implements planner-based agent orchestration, five typed memory classes, `VECTOR(1024)` semantic retrieval with hybrid ranking, company-scoped tenant isolation, persistent reflection loops, observability traces, idempotent memory deduplication, CockroachDB transaction retries, integration testing and CI. Built collaboratively for the CockroachDB × AWS AI Agent Hackathon.
...
- **[Book Store](https://github.com/cosmicoral/book_store)** — Python/Flask engineering exercises focused on web application fundamentals, testing, and CI/CD practices.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/coral-yu-han-phd-82a65649/)
[![Google Scholar](https://img.shields.io/badge/Google%20Scholar-4285F4?style=for-the-badge&logo=googlescholar&logoColor=white)](https://scholar.google.com/citations?user=Gp9ylswAAAAJ)
[![Last.fm](https://img.shields.io/badge/Last.fm-D51007?style=for-the-badge&logo=lastdotfm&logoColor=white)](https://www.last.fm/user/coral321)
