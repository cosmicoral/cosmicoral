...
- **[Mosaic Kitchen](https://github.com/cosmicoral/Mosaic-Kitchen-AI)** — Full-stack AI meal-planning and grocery platform for multicultural households, translating my PhD research on food practices into a consumer product. Built with **React + TypeScript, Node.js/Express, PostgreSQL and OpenAI structured outputs**, with **PostgreSQL-backed session auth, Google OAuth, Stripe billing, SSE streaming, deterministic post-generation validation, bilingual generation/translation, pantry-aware planning and AI usage metering**. Backed by **200+ automated tests** across authentication, billing, AI orchestration, data isolation and localisation. Designed around culturally specific food preferences, household inventory, budget-aware planning and food-waste reduction.
